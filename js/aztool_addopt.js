...
aztool.addopt_start = function(div_id, add_type) {
    ...
    webhid.set_aztool_mode(1, function() {
        if (aztool.option_add_type == 1) {
            ...
            aztool.addopt_expd_rotary_start();
        } else if (aztool.option_add_type == 3 || aztool.option_add_type == 9) {
            // PIM447 1Uトラックボール 
            aztool.addpim447tb_start(aztool.option_add_type);
...
aztool.option_add_read_check_exec = function(step_no) {
    ...
    } else if (aztool.option_add_type == 3 || aztool.option_add_type == 4 || aztool.option_add_type == 9) {
        // I2C PIM447 の状態を確認する
